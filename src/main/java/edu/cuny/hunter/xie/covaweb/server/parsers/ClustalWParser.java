...
public class ClustalWParser {
  static Logger logger = LoggerFactory.getLogger(ClustalWParser.class);
  ...
  public static MultipleSequenceAlignment<ProteinSequence,AminoAcidCompound> getMSA(
    ...
    // TODO slightly inefficient considering that the list is looped through
    // twice
    ...
    for (String key : labelToSequence.keySet()) {
      ProteinSequence temp = new ProteinSequence(labelToSequence.get(key)
          .toUpperCase());
